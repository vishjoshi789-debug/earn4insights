...
**Active (v15):** **Access-control + media-integrity wave — COMPLETE** (19 commits, `61b31af`→`c3c2767`). Two security batches, two incidents remediated, filtering + export shipped under a written claims policy. See `SESSION_RESUME.md` for the working detail, both incident records, and the open items below.
