...
const TOUR_STEPS: TourStep[] = [
  ...
  // ── Consumer-specific tour ──
  {
    ...
    description: 'Browse products from brands looking for your honest opinion. Each review you submit earns you rewards!',
    role: 'consumer',
    position: 'right',
    icon: '🛍️',
  },
  {
    target: '[data-tour="nav-rankings"]',
    title: '🏆 Weekly Top 10',
    description: 'See this week\'s highest-rated products, voted by consumers like you. Your reviews directly influence these rankings!',
    role: 'consumer',
    position: 'right',
    icon: '🏆',
  },
  ...
  },
  {
    ...
    description: 'Share detailed feedback on products you\'ve tried. Brands genuinely want to hear from you — and you get rewarded for it.',
    role: 'consumer',
    position: 'right',
    icon: '✍️',
  },
