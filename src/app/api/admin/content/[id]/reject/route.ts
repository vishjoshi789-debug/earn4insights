 ...
 *
 * Admin rejects any pending_review post with a reason (min 10 chars).
...
export async function POST(
  ...
  try {
    ...
    const result = await rejectContent(id, userId, body.reason, 'admin')
    ...
    console.error('[AdminReject POST]', error)
